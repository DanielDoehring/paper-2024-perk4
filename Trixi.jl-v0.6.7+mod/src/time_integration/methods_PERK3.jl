...
function ComputePERK3_ButcherTableau(NumStages::Int, BasePathMonCoeffs::AbstractString,
                                     cS2::Float64)
...
mutable struct PERK3
    ...
    function PERK3(NumStages_::Int, BasePathMonCoeffs_::AbstractString,
                   cS2_::Float64 = 1.0)
        newPERK3 = new(NumStages_)

        newPERK3.AMatrix, newPERK3.c = ComputePERK3_ButcherTableau(NumStages_,
                                                                   BasePathMonCoeffs_,
                                                                   cS2_)
        return newPERK3
    end
...
mutable struct PERK3_Integrator{RealT <: Real, uType, Params, Sol, F, Alg,
...
function get_proposed_dt(integrator::PERK3_Integrator)
